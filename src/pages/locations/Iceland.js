        ...
        <div>
            ...
            <div className='container'>
                <div className='all-text'>
                    <p>
                        When people ask for trip inspiration, I always ask if they have been to Iceland before. If they haven't, Iceland is always my first recommendation. Despite being smaller in land area than the state of Pennsylvania, Iceland has everything from glacier lagoons and massive waterfalls to volcanoes and moss canyons. The only downside to Iceland is the expenses... Iceland is extremely expensive! But if you can stomach the high prices of the country, Iceland is an absolute must-visit for any nature-lover. 
                ...
                <div className='image-text'>
                    ...
                    <p>
                        Iceland best shows off its incredible diversity best during the summer. The full ring road becomes easily accessible, and the high country roads open in late June, providing access to gems like Landmannalaguar. I recommend renting a car and driving around the full Ring Road (Route 1) to see the best of what Iceland provides. This itinerary alone would require at least one week to complete. If you have more time, I would recommend adding on Landmannalaguar and some of the other high country destinations in Iceland, as well as exploring the West Fjords and Snaesfelless Penninsula.
                        <br/><br/> The ring road contains enough destinations for a month-long trip! Therefore, when making your Iceland itinerary, you need to choose which locations you want to visit based on your preferences. 
                        <br/><br/>The best time to visit Iceland in my opinion is in September. During this month, all of Iceland is still accessible, with the added bonus of the nights being dark enough for the chance to see the northern lights. The northern lights tend to be strongest during the fall and spring equinoxes, so if you are able to time your trip to be during a new moon near September 21st, this would be ideal.
                ...
                <div className='bullets'>
                    ...
                    <li>Hverir: An area full of unique volcanic features similar to those found in Yellowstone... except you are allowed to get much closer to everything</li>
                ...
                <div className='all-text'>
                    <p>The examples provided here really are just scratching the surface! I'll finish off a list of other destinations that I went to since they are simply too many: Hverfjall Volcano, Krafla Viti Crater, Hengifoss, Reynisfjara Beach, Skogafoss, Seljalandsfoss, Gljufrabui, and of course the Golden Circle.</p>
                </div>
                ...
                <div className='image-text'>
                    ...
                    <p>
                        ...
                        <br/><br/> For the winter, I recommend sticking to just the south coast of Iceland, as the roads in the north of the island often become closed or impassable during this season due to the snow. Also note that the length of daylight during the winter in Iceland is very short, so you need to make the most out of the few hours of daylight you have each day! I recommend doing most of the driving during the darker hours for this reason. 
