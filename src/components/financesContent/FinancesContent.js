        ...
        <div className='finances-content'>
            <div className='container'>
                ...
                <div className='review'>
                    ...
                    <p>Qatar Airways's QSuite business class is quite possibly the best business class in the world. I flew it from Nepal back to New York for only 90,000 credit card points (which is equivalent to $900). The service was absolutely impeccable, and the seat features a lie-flat bed and a door to make the whole seat a small little private cubicle, which was awesome for helping me to sleep. 
                    <br /> <br />To make this redemption, I transferred 90,000 Capital One Miles from my Venture X to 90,000 British Airways Avios. Qatar Airways and British Airways have a partnership where you can connect your accounts from both airlines and then use the avios on either website. Therefore, I used the avios to book my Qatar Airways flight directly through Qatar Airways's website. Generally when looking for award flight redemption availability, you should either look many months in advance of a trip or last-minute for availability if flying to/from the USA. However if flying between 2 international destinations, there is often times more availbility.
                    <br /> <br />Generally, for One-World redemptions, Qatar QSuite and Cathay Pacific Business class are the sweet spots. Many credit cards can transfer to British Airways / Qatar Airways and Cathay Pacific. However, for most other redemptions, you will generally find the Star Alliance to have more options, which we will discuss next! </p>
                </div>
                <hr></hr>
